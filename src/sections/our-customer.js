...
const OurCustomer = () => {
  return (
    <Box id="customer" as="section" sx={styles.section}>
      <Container>
        <Flex sx={styles.contentWrapper}>
          ...
          <Box sx={styles.rightContent}>
            <SectionHeading
              sx={styles.heading}
              title="We have more than hundred of happy customer."
              description="We understand People flow in and between
buildings, making people's journeys safe, convenient and
reliable. Managed by a team of professionals with a right blend
of aggression with experience and exposure."
            />
